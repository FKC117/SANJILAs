"""
Django settings for sanjilas project.
...
SECRET_KEY = 'django-insecure-od7^u)m$6e7jlmpb0i^4*bm^g%dc6w65w6n5e#n#x8edkikfqq'
...
WSGI_APPLICATION = 'sanjilas.wsgi.application'
...
SUMMERNOTE_THEME = 'bs5'  # Options: 'bs3', 'bs4', 'bs5', 'lite'

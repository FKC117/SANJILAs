...
class ExpenseCategory(models.Model):
    ...
    name = models.CharField(max_length=100)
    code = models.CharField(max_length=20, unique=True, help_text="Expense account code (e.g., 5100)")
    description = models.TextField(blank=True)
...
class Payable(models.Model):
    ...
    expense_category = models.ForeignKey(ExpenseCategory, on_delete=models.SET_NULL, null=True, blank=True,
                                       related_name='payables', verbose_name='Expense Category',
                                       help_text='The category of expense this payable represents')
    status = models.CharField(max_length=20, choices=[
        ('PENDING', 'Pending'),
        ('PARTIAL', 'Partially Paid'),
        ('PAID', 'Paid'),
